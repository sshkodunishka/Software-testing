...
| Step | Expected result |
|--|--|
|Click "Фильтр" button|A window for selecting filters appears|
|Click "Со скидкой" button|A page with men's clothing at a discount has opened|
...
| Step | Expected result |
|--|--|
|Click "Новинки" button|A window with radio buttons for filtering appears|
|Click "Возрастающая цена" radio button|Opened a page with clothes sorted by price|
...
| Step | Expected result |
|--|--|
|Сlick on the field to enter your birthday|A calendar appeared|
|Сhoose a date of birth|The calendar has closed and a green checkmark appeared on the input field|
|Click "Сохранить" button|A window appears that says "Ваши данные обновлены!"|
|Click "OK" button|Opened the updated personal data page |
...
| Step | Expected result |
|--|--|
|Hover over the trash can icon|The trash icon will turn blue|
|Сlick on the trash icon|The selected clothing is removed|
...
|--|--|
|At the top of the site click on the "Поиск" field|Focused on this field|
|Enter "Капуста" in "Поиск" field|In the "Поиск" field the entered text is displayed|
|Click "Поиск" button to the right of "Поиск" field|Opened the page with the text "Извините, **"Капуста"  мы не смогли найти результат, соответствующий вашему поисковому запросу.**"|
...
|--|--|
|At the top of the site click on the "Поиск" field|Focused on this field|
|Enter "Sweater" in "Поиск" field|In the "Поиск" field the entered text is displayed|
|Click "Поиск" button to the right of "Поиск" field|Opened the page with the text "Извините, **"Sweater"  мы не смогли найти результат, соответствующий вашему поисковому запросу.**"|
...
_**Title:**_  Searching for a thing written in upper case
